...
const Riding = () => {
    return (
        <div className='h-screen'>
            <Link to='/home' className='h-10 w-10 fixed bg-white rounded-full flex items-center justify-center right-2 top-2'>
            ...
            <div className='h-1/2 p-4'>
                ...
                <button className='w-full bg-green-600 text-white font-semibold p-2 rounded-xl mt-5'>Make a Payment</button>
            </div>
        </div>
    )
}
